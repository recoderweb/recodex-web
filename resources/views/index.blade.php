            ...
            <div class="row gx-4 gx-xxl-5 align-items-center">
                <div class="col-xl-6 col-md-7">
                    <div class="theme__content__two text-md-start text-center">
                        ...
                        <a class="theme_btn" href="{{ route('home') }}">{{ __('home.btn.website') }}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row gx-4 gx-xxl-5 justify-content-center">
                <div class="col-lg-4 col-md-6" data-aos="fade-up">
                    <div class="feature-style-three text-center mb-45">
                        ...
                        <h3>
                            <a class="sect-title-two" href="{{ route('home') }}">{{ __('home.title.expertise') }}</a>
                        </h3>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="feature-style-three text-center mb-45">
                        ...
                        <h3>
                            <a class="sect-title-two" href="{{ route('home') }}">{{ __('home.title.innovation') }}</a>
                        </h3>
                ...
                <div class="col-lg-4 col-md-8" data-aos="fade-rup" data-aos-delay="200">
                    <div class="feature-style-three text-center mb-45">
                        ...
                        <h3>
                            <a class="sect-title-two" href="{{ route('home') }}">{{ __('home.title.quality') }}</a>
                        </h3>
            ...
            <div class="row gx-4 gx-xxl-5 align-items-center">
                ...
                <div class="col-xxl-4 col-xl-4 col-md-6  order-1" data-aos="fade-up" data-aos-delay="100">
                    <div class="block-style-three mb-45">
                        ...
                        <a class="theme_btn mt-55" href="{{ route('home') }}">{{ __('home.btn.details') }}</a>
                    </div>
                </div>
            ...
            <div class="row gx-4 gx-xxl-5">
                <div class="col-lg-4 col-md-6" data-aos="fade-up">
                    <div class="feature-style-four mb-45">
                        ...
                        <h2>
                            <a class="sect-title-two" href="{{ route('service') }}">{{ __('home.title.webdev') }}</a>
                        </h2>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="feature-style-four mb-45">
                        ...
                        <h2>
                            <a class="sect-title-two" href="{{ route('service') }}">{{ __('home.title.hosting') }}</a>
                        </h2>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="feature-style-four mb-45">
                        ...
                        <h2>
                            <a class="sect-title-two" href="{{ route('service') }}">{{ __('home.title.domain') }}</a>
                        </h2>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="feature-style-four mb-45">
                        ...
                        <h2>
                            <a class="sect-title-two"
                                href="{{ route('service') }}">{{ __('home.title.e-commerce') }}</a>
                        </h2>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="feature-style-four mb-45">
                        ...
                        <h2>
                            <a class="sect-title-two" href="{{ route('service') }}">{{ __('home.title.ui-ux') }}</a>
                        </h2>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                    <div class="feature-style-four mb-45">
                        ...
                        <h2>
                            <a class="sect-title-two"
                                href="{{ route('service') }}">{{ __('home.title.programming') }}</a>
                        </h2>
                ...
                <div class="col-lg-4">
                    <div class="case-item-one">
                        ...
                        <div class="case-content">
                            ...
                            <p>Creating Company Profile Website for Alfa5 Aviation.</p>
                ...
                <div class="col-lg-4">
                    <div class="case-item-one">
                        ...
                        <div class="case-content">
                            ...
                            <p>Creating Company Profile Website for Private Jet Charter Indonesia.</p>
                ...
                <div class="col-lg-4">
                    <div class="case-item-one">
                        ...
                        <div class="case-content">
                            ...
                            <p>Creating Company Profile Website for Berlima Inflight Catering.</p>
                    ...
                    <div class="case-item-one">
                        ...
                        <div class="case-content">
                            ...
                            <h3><a class="sect-title-two" href="https://berlianflightsupport.com">Berlian Ground
                                    Support</a></h3>
                            <p>Creating Company Profile Website for Berlian Ground Support.</p>
                ...
                <div class="col-lg-4">
                    <div class="case-item-one">
                        ...
                        <div class="case-content">
                            ...
                            <p>Creating Company Profile Website for Alfalimasatu.</p>
                ...
                <div class="col-lg-4">
                    <div class="case-item-one">
                        ...
                        <div class="case-content">
                            ...
                            <p>Creating Company Profile Website for Blueverizon.</p>
                            <a class="case-btn" href="project-details.html"><i class="bi bi-arrow-up-right"></i></a>
                        </div>
                    </div>
                </div>
