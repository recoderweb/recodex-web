            ...
            <div class="row gx-4 gx-xxl-5 justify-content-center">
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="team-style-one text-center mb-45">
                        <a href="#"><img src="{{ asset('img/team/team-1b.jpg') }}" alt="img"></a>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="team-style-one text-center mb-45">
                        <a href="#"><img src="{{ asset('img/team/team-2b.jpg') }}" alt="img"></a>
                        <div class="team-content">
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="team-style-one text-center mb-45">
                        <a href="#"><img src="{{ asset('img/team/team-3b.jpg') }}" alt="img"></a>
                        <div class="team-content">
